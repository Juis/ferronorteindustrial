 ...
 * @property integer $usuario_cadasro
...
class EstadoCivil extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('descricao, data_cadastro, usuario_cadasro', 'required'),
			array('ativo, usuario_cadasro, usuario_altera', 'numerical', 'integerOnly'=>true),
			array('descricao', 'length', 'max'=>100),
			array('data_altera', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, descricao, ativo, data_cadastro, usuario_cadasro, data_altera, usuario_altera', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'trabalheConoscos' => array(self::HAS_MANY, 'TrabalheConosco', 'estado_civil_id'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'usuario_cadasro' => 'Usuario Cadasro',
	...
	public function search()
	{
		...
		$criteria->compare('usuario_cadasro',$this->usuario_cadasro);
